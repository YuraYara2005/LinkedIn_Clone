    ...
    <div class="report-card">
        <div class="report-header">
            ...
            <div>
                ...
                <a href="<?php echo URLROOT; ?>/reports/export/postings" class="btn-download">
                    ...
                    <tbody>
                        <?php foreach ($data['report_data'] as $row): ?>
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars(date('Y-m-d', strtotime($row->posted_date))); ?></td>
                                <td><?php echo htmlspecialchars($row->application_count); ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
            <?php else: ?>
                <p class="text-muted">No job postings data available.</p>
            <?php endif; ?>
        </div>
    </div>
</div>
